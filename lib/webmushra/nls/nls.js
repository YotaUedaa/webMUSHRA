...
nls['ja']['nextButton'] = "次へ";
nls['ja']['previousButton'] = "前へ"; 
nls['ja']['playButton'] = "再生";
nls['ja']['stopButton'] = "停止"; 
nls['ja']['pauseButton'] = "停止";
nls['ja']['sendButton'] = "結果を表示する";
...
nls['ja']['imperceptible'] = "非常に自然";
nls['ja']['perceptible'] = "自然"; 
nls['ja']['slightly'] = "中間";
nls['ja']['annoying'] = "不自然"; 
nls['ja']['very'] = "非常に不自然";
...
nls['en']['attending'] = "ご参加ありがとうございました";
