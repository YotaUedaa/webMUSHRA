...
function NESPage(_reference, _condition, _pageManager, _pageTemplateRenderer, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _errorHandler, _language) {
...
NESPage.prototype.getName = function () {
  return this.pageConfig.name;
};

NESPage.prototype.init = function () {
...
NESPage.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
...
/*jshint multistr: true */
  ...
  var trNames = $("<tr><td></td><td></td><td>A</td><td>B</td></tr>");
  tableBS1116.append(trNames);
  
  var trPlays = $("<tr></tr>");

  var buttonPlayReference = $("<td id='tdPlayButton' ></td>");
...
NESPage.prototype.pause = function() {
    this.mushraAudioControl.pause();
}


NESPage.prototype.setLoopStart = function() {
...
NESPage.prototype.setLoopEnd = function() {
  var slider = document.getElementById('slider'); 
...
NESPage.prototype.renderCanvas = function(_parentId) {
...
NESPage.prototype.cleanButtons = function() {
...
NESPage.prototype.btnCallbackReference = function() {
...
NESPage.prototype.btnCallbackB = function() {
	this.currentItem = "B";
...
NESPage.prototype.btnCallbackC = function() {
	this.currentItem = "C";
...
NESPage.prototype.load = function () {
...
NESPage.prototype.save = function () {
 this.bacic.unbind();
...
NESPage.prototype.store = function () {
